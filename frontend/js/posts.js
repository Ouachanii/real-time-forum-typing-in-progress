...
function createPostElement(postData) {
  ...
  postDiv.innerHTML = `
    <div class="post-header">
      <img src="/frontend/assets/profile.png" width="36" height="36" class="post-avatar" alt="user avatar">
      ...
      ${commentCount > 0 ? postData.Comments.map(comment => `
        <div class="comment">
          <div class="comment-header">
            <img src="/frontend/assets/profile.png" width="32" height="32" class="comment-avatar">
            <div class="author-time-container">
